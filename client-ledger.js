// client-ledger.js — simple client-side ledger stored in localStorage
(function(){
  const KEY = 'suraya_ledger_v1';
  const LAST_WORK_KEY = 'suraya_last_work_v1';
  const ADMIN_PASS = 'suraya-admin-2026'; // prototype default — change in PR notes
  ...
  const Ledger = window.Ledger = {
    ...
    getAdminPassword(){ return ADMIN_PASS; }
  };
